...
# sidebar_hint and sidebar_pills are imported from rbv.ui.sidebar_inputs (Phase 4.1).
...
# RBV_SIDEBAR_TOOLTIPS is imported from rbv.ui.sidebar_inputs (Phase 4.1).
...
try:
    ...
    _pdf_cfg = {
        ...
        for k, v in {
            ...
            "rate": 5.0,
            "amort": 25,
            "property_tax_rate_annual": 1.0,
            "maintenance_rate_annual": 1.0,
            "repair_rate_annual": 0.5,
            "selling_cost_pct": 5.0,
            "condo_fee_monthly": 0.0,
            "home_insurance_monthly": 0.0,
            "rent_insurance_monthly": 0.0,
            "rent_inflation_rate_annual": 2.5,
            "general_inflation_rate_annual": 2.0,
            "nm": 300,
        }.items()
    }
