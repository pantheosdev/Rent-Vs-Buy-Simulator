...
def run_simulation_core(
    ...
    *,
    ...
    assume_sale_end = as_bool(cfg.get("assume_sale_end", False))
    show_liquidation_view = as_bool(cfg.get("show_liquidation_view", False))
    is_principal_residence_cfg = as_bool(cfg.get("is_principal_residence", True))
    ...
    reg_shelter_enabled = as_bool(cfg.get("reg_shelter_enabled", False))
    ...
    is_foreign_buyer = as_bool(cfg.get("is_foreign_buyer", False))
    first_time_buyer = as_bool(cfg.get("first_time", cfg.get("first_time_buyer", True)))
    new_construction = as_bool(cfg.get("new_construction", cfg.get("new_build", False)))
    ...
    if is_foreign_buyer:
        ...
        _fb_toronto = as_bool(cfg.get("toronto", False))
    ...
    hbp_enabled = as_bool(cfg.get("hbp_enabled", False)) and bool(first_time_buyer)
    hbp_withdrawal = 0.0
    ...
    fhsa_enabled = as_bool(cfg.get("fhsa_enabled", False)) and bool(first_time_buyer)
    fhsa_supplement = 0.0
    fhsa_tax_saving = 0.0
    if fhsa_enabled:
