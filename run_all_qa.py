...
def _run_suite(name: str) -> int:
    ...
    elif name == "equity_checks":
        from rbv.qa.qa_equity_checks import main as _main
    else:
...
def main(argv: list[str] | None = None) -> int:
    ...
    suites = ["smoke", "scenarios", "sensitivity", "golden", "city_presets", "truth_tables", "costs_utils", "costs_core", "equity_checks"]
